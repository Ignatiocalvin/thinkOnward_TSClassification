...
def get_pred(X, classifier_list, column_list):
    ...
    y_pred.loc[y_pred_type == 'commercial', y_pred.columns.str.endswith('_com')] = y_pred_commercial
    y_pred.loc[y_pred_type == 'residential', y_pred.columns.str.endswith('_res')] = y_pred_residential
...
def sample_submission_generator(bldg_id_list, df_targets, path_to_save):
    ...
    building_stock_type_distribution = df_targets['building_stock_type'].value_counts(normalize=True)
